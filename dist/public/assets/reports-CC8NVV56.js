import{j as t}from"./vendor-ui-DJm-zmnP.js";import{r as f}from"./vendor-react-Bzsngnqy.js";import{a as w}from"./vendor-query-CX8ZYlKb.js";import{a6 as L,C as j,f as u,L as S,I as b,B as N,V as v,x as C,y as R,a7 as $}from"./index-61RjstaY.js";import{T as y,a as I,b as x,c as d,d as F,e as l}from"./table-B7L5kFC6.js";import{T as E}from"./trending-up-CK4Nk2TF.js";import{T as G}from"./trending-down-3gb6g0y8.js";import"./vendor-utils-BKCsaWdX.js";function q(s){return s.map(c=>{const n={};return Object.keys(c).forEach(r=>{!r.startsWith("_")&&r!=="__v"&&r!=="password"&&r!=="token"&&(n[r]=c[r])}),n})}function T(s,c){if(!s||s.length===0){console.error("No data to export");return}const n=q(s),r=Object.keys(n[0]),a=[r.join(","),...n.map(h=>r.map(g=>`"${h[g]||""}"`).join(","))].join(`
